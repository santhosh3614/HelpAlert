...
public class Registration extends Activity implements OnClickListener {
	...
	public static EditText name, phonenumber, address, emergency_name, emergency_number;
	...
	Pattern vaddr = Pattern.compile("[A-Za-z]*");
	...
	public void save() {
		...
		Preferences.writeString(this, Preferences.PHONE_NUMBER, phonenumber.getText().toString());
		...
		Preferences.writeString(this, Preferences.EM_NUMBER, emergency_number.getText().toString());
	...
	//	address = (EditText) findViewById(R.id.home_address_field);
		getaddress=(((EditText)findViewById(R.id.home_address_field)).getText()).toString();
		if (!StringUtils.isValidString(getaddress)) {
