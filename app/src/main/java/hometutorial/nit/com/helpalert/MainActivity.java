...
public class MainActivity extends Activity {
	...
	/*
	 * HOSPITAL, POLICE, FIRESTATION, and AMBULANCE are constant variables that
	 * are assigned to their respective emergency itent. It helps us to draw
	 * icons and perform web services related activities.
	 */
	...
	/**
	 * This is the main screen of our application. This is the first screen
	 * shown after a user has registered. The registration screen only shows if
	 * it is the users first time using the application.
	 *
	 * @param v
	 */
